...
const MidSocials = () => {
  return (
    <div className="font-poppin othersBG">
        ...
        <div className="grid lg:grid-cols-3 lg:gap-5 gap-6">
          {photos.map((item, index) => (
            <a
              ...
              key={index}
            >
              <div className="absolute z-[50] top-0 right-0 left-0 bottom-0 rounded-2xl group-hover:bg-black/70 duration-300 group-hover:text-white flex justify-center items-center p-5 text-transparent">
              ...
              <Image src={item.href} alt="/" fill className="rounded-2xl" />
            </a>
          ))}
        </div>
      </div>
